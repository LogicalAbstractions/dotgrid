...
namespace System.Buffers.Text
{
    public abstract partial class SymbolTable
    {
        ...
        public unsafe bool TryEncode(ReadOnlySpan<char> source, Span<byte> destination, out int bytesConsumed, out int bytesWritten)
        {
            ...
            var tempBytes = stackalloc byte[BufferSize];
            Span<byte> temp = new Span<byte>(tempBytes,BufferSize);
